...
namespace RakNetWrapper
{
    ...
    public:
        ...
        StartupResult Startup(IPEndPoint^ endpoint, unsigned short maxConnections, int timeOutMs);

        ConnectionAttemptResult Connect(IPEndPoint^ endpoint);
